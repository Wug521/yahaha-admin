...
public class HelloOSS {
    ...
    private static String accessKeyId = "LTAIn21TtkpTOjsp";
    private static String accessKeySecret = "jcvZK0lIx4cQ37uMCVaTSOT3r2Mqcn";

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "yahaha-cloud";

    // Object是OSS存储数据的基本单元，称为OSS的对象，也被称为OSS的文件。详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Object命名规范如下：使用UTF-8编码，长度必须在1-1023字节之间，不能以“/”或者“\”字符开头。
    
	public static ClientConfiguration getClientConf() {
...
//        logger.info("Started");
        ...
        ClientConfiguration conf = getClientConf();
        ...
        try {
            ...
            /*File file = new File("F:\\MyDownloads\\20190428143242340.jpg");
            ...
            ossClient.putObject(bucketName, "20190428143242340.jpg", is);
            System.out.println("Object：" + "20190428143242340.jpg" + "存入OSS成功。");*/
...
//            System.out.println("Object：" + firstKey + "的内容是：" + objectContent);
            ...
            // 链接地址是：https://help.aliyun.com/document_detail/oss/sdk/java-sdk/upload_object.html?spm=5176.docoss/user_guide/upload_object
            String fileKey = "demo.bat";
            File file = new File("F:\\Local\\BAT\\demo.bat");
            InputStream input = new FileInputStream(file);
            PutObjectResult putObject = ossClient.putObject(bucketName, fileKey, input);
            System.out.println(JSONUtil.object2String(putObject));
            /*System.out.println(putObject.getResponse().getUri());
            System.out.println(putObject.getResponse().isSuccessful());*/
...
//            ossClient.deleteObject(bucketName, "20190428143242340.jpg");
//            System.out.println("删除Object：" + "20190428143242340.jpg" + "成功。");
