...
public class AplAuthorizationAttributeSourceAdvisor extends StaticMethodMatcherPointcutAdvisor{
	private static final long serialVersionUID = 1L;
	static final Logger logger = LoggerFactory.getLogger(AplAuthorizationAttributeSourceAdvisor.class);
     ...
     */
    public AplAuthorizationAttributeSourceAdvisor() {
        setAdvice(new AplAnnotationsAuthorizingMethodInterceptor());
    }
