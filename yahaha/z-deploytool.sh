...
host="47.111.99.248" # 服务器地址
REMOTE_TOMCAT_DIR="/home/tomcat/apache-tomcat-8.5.40" # 远程服务器Tomcat目录
REMOTE_JAVA_HOME="/usr/bin/" # 远程服务器jdk环境变量

user="root" # 用户名

# 本地应用路径
app_file="C:/Users/DELL/Documents/个人文档/yahaha-admin/yahaha/yahaha-web/target/yhh-web.war"
# 本地应用目录
 ...
 * see           : https://github.com/yangb92/remote_release
 * *******************************************************
!
