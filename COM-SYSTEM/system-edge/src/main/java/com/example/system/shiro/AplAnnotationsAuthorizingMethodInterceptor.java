...
public class AplAnnotationsAuthorizingMethodInterceptor 
      extends AnnotationsAuthorizingMethodInterceptor implements MethodInterceptor{
	
	public AplAnnotationsAuthorizingMethodInterceptor() {
        ...
        interceptors.add(new AplPermissionAnnotationMethodInterceptor(resolver));
